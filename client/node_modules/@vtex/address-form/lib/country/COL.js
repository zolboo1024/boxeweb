...
exports.default = {
  ...
  geolocation: {
    postalCode: {
      ...
      handler: function handler(address) {
        if (!address.state || !address.city || !address.state.value || !address.city.value) {
          return address;
        }

        if (countryData[address.state.value] && countryData[address.state.value][address.city.value]) {
          address.postalCode = {
    ...
    street: {
      valueIn: 'long_name',
      types: ['route'],
      handler: function handler(address, googleAddress) {
  ...
  summary: [[{ name: 'street' }, { delimiter: ', ', name: 'number' }, { delimiter: ' ', name: 'complement' }], [{ name: 'postalCode' }, { delimiter: ' ', name: 'city' }, { delimiter: ' ', name: 'state' }]]
};
