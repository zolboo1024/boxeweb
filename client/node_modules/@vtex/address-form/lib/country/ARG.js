...
exports.default = {
  ...
  fields: [{
    ...
    size: 'large',
    level: 1,
    options: (0, _addressFieldsOptions.getOneLevel)(countryData)
  }, {
    name: 'city',
    maxLength: 100,
    label: 'city',
    ...
    level: 2,
    basedOn: 'state',
    optionsMap: (0, _addressFieldsOptions.getTwoLevels)(countryData)
  }, {
    name: 'receiverName',
  ...
  summary: [[{ name: 'street' }, { delimiter: ' ', name: 'number' }], [{ name: 'complement' }], [{ name: 'postalCode' }], [{ name: 'city' }, { delimiter: ', ', name: 'state' }]]
};
