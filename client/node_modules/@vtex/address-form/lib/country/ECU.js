...
exports.default = {
  country: 'ECU',
  abbr: 'EC',
  postalCodeFrom: _constants.ONE_LEVEL,
  postalCodeLevels: ['state'],
  firstLevelPostalCodes: (0, _postalCodes.firstLevelPostalCodes)(countryData),
  fields: [{
    hidden: true,
    name: 'country',
    maxLength: 100,
  ...
  summary: [[{ name: 'street' }, { delimiter: ' ', name: 'number' }, { delimiter: ' ', name: 'complement' }], [{ name: 'neighborhood' }], [{ name: 'postalCode' }, { delimiter: ' ', name: 'city' }, { delimiter: ', ', name: 'state' }]]
};
